/* Saturday 6th of June 2015 08:33:16 PM*/
...
if(tmpModernizr) window.Modernizr = tmpModernizr;var tmpModernizr = null;
if(typeof window.Modernizr !== "undefined" ) tmpModernizr = window.Modernizr;
...
})(njQuery);window.njQuery = typeof jQuery == "undefined" ? null : jQuery;
...
(function($){ $(document).ready(function() {$("#nextend-smart-slider-5 .nextend-bullet-container .nextend-bullet:not([data-thumbnail=\"\"])").qtip({
                    position: {
                        my: "bottom center",
                        at: "top center",
                        adjust: {
